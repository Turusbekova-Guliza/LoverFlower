                        ...
                        <div className="home-main">
                            ...
                            <div className="home-main__content">
                                <div className="home-main__btn">
                                    <div style={{color: "white"}} className="subtitle_big subtitle_center">Создаём для тех, кто ценит свежесть и изящество цветка</div>
                                    <a href="../catalog.html" className="btn btn_colored">смотреть каталог</a>
                                    <div className="home-main__contacts-call modal__btn modal__btn_mobile" data-modal>заказать звонок</div>
                                </div>
